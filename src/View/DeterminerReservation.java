...
import Controleurs.ControleurDeterminerReservation;
...
public class DeterminerReservation extends JDialog{
    ...
    public void setDeterminerReservationControleur(ControleurDeterminerReservation controleurDeterminerReservation)
    {
        buttonPrevius.addActionListener(controleurDeterminerReservation);
        buttonNext.addActionListener(controleurDeterminerReservation);
        buttonReservation.addActionListener(controleurDeterminerReservation);
    }

    public static void main(String[] args)
    {
        DeterminerReservation determinerReservation = new DeterminerReservation();
